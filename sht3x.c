...
int16_t sht3x_measure_blocking_read( sht3x_i2c_addr_t addr,
                                     int32_t* temperature,
                                     int32_t* humidity )
{
...
int16_t sht3x_read( sht3x_i2c_addr_t addr,
                    int32_t* temperature,
                    int32_t* humidity)
{
    uint16_t words[2];
    int16_t ret = sensirion_i2c_read_words(addr, words, SENSIRION_NUM_WORDS(words));
    /**
...
{
    uint16_t status;
    return sensirion_i2c_delayed_read_cmd( addr,
...
int16_t sht3x_read_serial(sht3x_i2c_addr_t addr, uint32_t* serial)
{
    ...
    if (ret == STATUS_OK)
    {
        ret = sensirion_i2c_read_words_as_bytes( addr, 
                                                 serial_bytes,
...
int16_t sht3x_set_alert_thd( sht3x_i2c_addr_t addr,
...
int16_t sht3x_get_alert_thd( sht3x_i2c_addr_t addr,
                             sht3x_alert_thd_t thd,
                             int32_t* humidity,
                             int32_t* temperature )
{
