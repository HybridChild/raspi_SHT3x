...
int8_t sensirion_common_check_crc( const uint8_t* data,
                                   uint16_t count,
                                   uint8_t checksum )
{
...
int16_t sensirion_i2c_read_words_as_bytes( uint8_t address,
                                           uint8_t* data,
                                           uint16_t num_words )
{
    int16_t ret;
                                  ...
                                  uint16_t num_words )
{
    ...
    ret = sensirion_i2c_read_words_as_bytes( address,
                                             (uint8_t*)data_words,
                                             num_words );
    if (ret != NO_ERROR)
        return ret;
...
int16_t sensirion_i2c_delayed_read_cmd( uint8_t address,
                                        uint16_t cmd,
                                        uint32_t delay_us,
                                        uint16_t* data_words,
                                        uint16_t num_words )
{
    ...
    sensirion_fill_cmd_send_buf(buf, cmd, NULL, 0); // Simply puts the command in the buffer
...
int16_t sensirion_i2c_read_cmd( uint8_t address,
                                uint16_t cmd,
                                uint16_t* data_words,
                                uint16_t num_words )
{
